                    ...
                    <div class="col-md-6 col-sm-12">
                        ...
                        @if ($konten->file)
                            @if ($ext=='pdf')
                                ...
                                <iframe src="http://docs.google.com/viewer?url={{ url('show-image/'.$konten->file) }}&embedded=true" width="100%" height="700px" style="width: 100%; height: 700px;" frameborder="0" scrolling="no"></iframe>
                            @else
